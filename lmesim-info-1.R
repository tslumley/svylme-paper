...
stage1$gvar<-with(stage1, ave(e,g,FUN=var))
medvar<-median(stage1$gvar)
stage1$ns<-with(stage1, ifelse(gvar<medvar, 2, 6))
...
rvalinf1<-vector("list",1000)


set.seed(2018-11-7)
for(i in 1:1000){
	print(i)
	rvalinf1[[i]]<-one.simeffinf1()
}
